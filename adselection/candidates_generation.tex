...
%\end{definition}
A minhash function $f(\cdot)$ maps an input concept set to an integer.  The minhash function family
...
The collision %(i.e., with same LSH signature) 
...
We pre-computed LSH signatures for $p\in{}P$.%bid phrases' corresponding concept
%sets.
